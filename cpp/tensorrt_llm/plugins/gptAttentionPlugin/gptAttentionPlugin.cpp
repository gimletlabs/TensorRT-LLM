...
IPluginV2* GPTAttentionPluginCreator::createPlugin(char const* name, PluginFieldCollection const* fc) noexcept
{
    ...
    try
    {
        auto* obj = new GPTAttentionPlugin(p.getScalar<int32_t>("layer_idx").value(),
            ...
            static_cast<PositionEmbeddingType>(p.getScalar<int32_t>("position_embedding_type").value()),
            p.getScalar<int32_t>("rotary_embedding_dim").value(), p.getScalar<float>("rotary_embedding_base").value(),
            static_cast<RotaryScalingType>(p.getScalar<int32_t>("rotary_embedding_scale_type").value()),
            ...
            BlockSparseParams{p.getScalar<int32_t>("block_sparse_block_size").value(),
                static_cast<bool>(p.getScalar<int32_t>("block_sparse_homo_head_pattern").value()),
            ...
            static_cast<bool>(p.getScalar<int32_t>("qkv_bias_enabled").value()),
            static_cast<bool>(p.getScalar<int32_t>("do_cross_attention").value()),
            static_cast<int32_t>(p.getScalar<int32_t>("max_distance").value()),
            static_cast<bool>(p.getScalar<int32_t>("pos_shift_enabled").value()),
            static_cast<bool>(p.getScalar<int32_t>("dense_context_fmha").value()),
            static_cast<bool>(p.getScalar<int32_t>("use_paged_context_fmha").value()),
            static_cast<bool>(p.getScalar<int32_t>("use_fp8_context_fmha").value()),
            static_cast<bool>(p.getScalar<int32_t>("has_full_attention_mask").value()),
            static_cast<bool>(p.getScalar<int32_t>("use_cache").value()),
            static_cast<bool>(p.getScalar<int32_t>("is_spec_decoding_enabled").value()),
            static_cast<bool>(p.getScalar<int32_t>("spec_decoding_is_generation_length_variable").value()),
            p.getScalar<int32_t>("spec_decoding_max_generation_length").value(),
            static_cast<int8_t>(p.getScalar<int32_t>("is_mla_enabled").value()),
            ...
            static_cast<bool>(p.getScalar<int32_t>("fuse_fp4_quant").value()),
            static_cast<bool>(p.getScalar<int32_t>("skip_attn").value()),
