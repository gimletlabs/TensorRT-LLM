...
namespace cutlass_kernels
{
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, float, float, float,
                EpilogueOpDefault, NONE, 256, 64, 32, 2, 1, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, float, float, float,
                EpilogueOpDefault, NONE, 256, 256, 32, 2, 2, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, float, float, float,
                EpilogueOpDefault, NONE, 256, 256, 32, 2, 1, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, float, float, float,
                EpilogueOpDefault, NONE, 256, 512, 32, 2, 2, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 256, 64, 256, 2, 1, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 256, 128, 256, 2, 2, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 256, 128, 256, 2, 1, 1, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 256, 256, 256, 2, 2, 1, false);
