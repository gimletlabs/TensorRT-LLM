...
void run_fmha_v2_flash_attention_bf16_64_128_S_q_paged_kv_192x128_sm100_nl(
  ...
  if( launch_params.attention_mask_type == Attention_mask_type::CAUSAL ) {
    ...
    fmha_v2_flash_attention_bf16_64_128_S_q_paged_kv_192x128_custom_mask_sm100_kernel_nl<<<grid, Kernel_traits_nl::THREADS, Kernel_traits_nl::BYTES_PER_SMEM, stream>>>(reinterpret_cast<bert::Fused_multihead_attention_params_v2 &>(params));
#endif // custom mask
  }
}
...
void run_fmha_v2_flash_attention_bf16_64_128_S_q_paged_kv_192x128_sm100_nl_tiled(
  ...
  if( launch_params.attention_mask_type == Attention_mask_type::CAUSAL ) {
    ...
    fmha_v2_flash_attention_bf16_64_128_S_q_paged_kv_192x128_custom_mask_sm100_kernel_nl_tiled<<<grid, Kernel_traits_nl_tiled::THREADS, Kernel_traits_nl_tiled::BYTES_PER_SMEM, stream>>>(reinterpret_cast<bert::Fused_multihead_attention_params_v2 &>(params));
#endif // custom mask
  }
}
